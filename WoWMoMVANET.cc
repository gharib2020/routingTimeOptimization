...
static double TxRange=138.2;//Transmit range: for txp=7.5 dbm it is 138.8 m
...
int main (int argc, char *argv[])
{
  ...
  uint32_t mobilityModel=3;//1-3d RWP, 2-3d GaussMarkov, 3-2d RWp, 4- 2d G-M   
...
switch (mobilityModel)
  ...
  double density;
  density=(X*Y)/(M_PI*pow(TxRange,2));//how many spheres fit the entire space
